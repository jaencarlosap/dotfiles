...
// toast tambien te deja VER el coste del thinking. Con `auto` en
// reasoningEffort "low" apenas veras 🧠; el ejemplo original era el agente
// `analyze` en "medium", que se elimino el 2026-09-07.
//
